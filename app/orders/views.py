...
from .services import mark_order_completed, mark_order_failed
...
class CreateStripePaymentIntentView(APIView):
    ...
    def post(self, request):
        serializer = CreateStripePaymentIntentSerializer(
...
class StripeConfigView(APIView):
    """Expone la publishable key para inicializar Stripe.js en frontend."""
